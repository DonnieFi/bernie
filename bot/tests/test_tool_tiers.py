...
_EXPECTED_TOOL_COUNT = 121  # ratchet: subscription provider status + current registry
...
class TestToolTiers(unittest.TestCase):
    ...
    def test_registry_tool_count(self):
        ...
        self.assertEqual(
            ...
            f"Expected {_EXPECTED_TOOL_COUNT} tools; update this ratchet when registry changes are intentional",
        )
