...
def build_summary_embed(
    ...
    *,
    ...
    # 3. Schedule & Homework (shared projection with /api/today)
    display, school = select_daily_schedule(events, config)
    if not display:
    ...
    homework_due = homework_due_events(school, config, target_date)
    if homework_due:
        hw_lines = []
