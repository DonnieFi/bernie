...
MIGRATION_SPECS: list[tuple[int, str, str]] = [
    ...
    (10, "meals_grocery_web_schema", "ensure_meals_grocery_web_schema"),
    # v10 shipped before gcal_event_id was added; applied databases need a new version.
    (11, "meals_gcal_event_id", "ensure_meals_grocery_web_schema"),
]
