...
async def conversation_history_in_range(
    utc_start: str, utc_end: str, *, limit: int = 2000
) -> list[dict]:
    # family-bot-t7h: hard cap range scans (callers can page via scroll_* APIs)
