...
_BUILTIN_VEHICLE_PROFILES: dict[str, dict[str, dict[str, str]]] = {
    "familycar": {
        "core": {
            "lock": "lock.familycar_door_lock",
            "ev_battery_pct": "sensor.familycar_ev_battery_level",
            "plugged_in": "binary_sensor.familycar_ev_battery_plug",
            "charging": "switch.familycar_ev_charging",
            "location": "device_tracker.familycar_location",
            "last_updated": "sensor.familycar_last_updated_at",
        },
        "extras": {
            "ev_range_km": "sensor.familycar_ev_range",
            "total_range_km": "sensor.familycar_total_driving_range",
            "odometer": "sensor.familycar_odometer",
            "climate_on": "switch.familycar_climate",
            "fuel_pct": "sensor.familycar_fuel_level",
            "battery_12v_pct": "sensor.familycar_car_battery_level",
        },
    },
}
