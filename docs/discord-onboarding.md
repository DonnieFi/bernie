...
- [ ] `docker compose -f docker-compose.public.yml up` → test message in main channel
...
Homelab hosts with LAN certs / extra mounts use `docker compose up` (`docker-compose.yml`) instead.
